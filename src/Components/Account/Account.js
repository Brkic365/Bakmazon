      ...
      <div className="acc__content">
        <div className="acc__main-details">
          <div className="acc__pfp">
            <img src={pfpUrl} className="acc__pfp-img" alt={pfpUrl} />
            {auth.currentUser && auth.currentUser.displayName && (
              <p onClick={() => fileInput.current.click()}>
        ...
        <div className="acc__inputs">
          ...
          <CustomInput
            names={["Phone number (optional)", "ZIP Code"]}
            parentCallback={handleCallback}
          />
          <CustomInput
            names={["Country", "Town/City"]}
            parentCallback={handleCallback}
          />
          <CustomInput names="Address" parentCallback={handleCallback} />
          <CustomInput
            names="Company Name (optional)"
            parentCallback={handleCallback}
          />
