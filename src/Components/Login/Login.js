        ...
        <div className="login">
            <div className="login__login">
                ...
                <div className="login__login-container">
                    <p>If you already have an account, you can login here using your credentials.</p>
            ...
            <div className="login__register">
                ...
                <div className="login__register-container">
                    <p>Creating an account has many benefits: email notifications, faster orders, order history and collecting coupons.</p>
